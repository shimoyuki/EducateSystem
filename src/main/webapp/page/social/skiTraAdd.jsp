...
<body>
	...
	<div id="id_11">
		...
		<!--表格区-->
		<form id="formSkiTra" action="<%=basePath%>skiTra/saveSkiTra"
			method="post">
						...
						<div id="id_25" style="border: none;">
													...
													<select class="form-control" name="year">
														...
														<c:forEach var="i" begin="1" end="50">
															<option value="${curYear-i}"
																<c:if test="${skiTra.year == (curYear-i) }">selected="selected"</c:if>>${curYear-i}</option>
														</c:forEach>
													</select>
												</div></td>
										</tr>
							...
							<div class="id_29" style="clear:both">
								...
								<input id="reset" class="id_31" type="reset"
									onclick="location.href='showSkiTraInfo'"
									value="返回">
							</div>
						</div>
					</td>
