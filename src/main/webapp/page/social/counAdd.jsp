...
<body>
	...
	<div id="id_11">
		...
		<!--表格区-->
		<form id="formCoun" action="<%=basePath%>coun/saveCoun" method="post">
				...
				<tr>
					<td>
						<div id="id_25" style="border: none;">
													...
													<select class="form-control" name="year">
														...
														<c:forEach var="i" begin="1" end="50">
															<option value="${curYear-i}"
																<c:if test="${coun.year == (curYear-i) }">selected="selected"</c:if>>${curYear-i}</option>
														</c:forEach>
													</select>
												</div></td>
										</tr>
							...
							<div class="id_26" style="float: left;">
								<h5>
									<span id="FormView1_Label1"></span>添加扶贫技术或项目名称
								</h5>
								<div>
							...
							<div class="id_29" style="clear:both">
								...
								<input id="reset" class="id_31" type="reset"
									onclick="location.href='showCounInfo'"
									value="返回">
							</div>
						</div>
					</td>
