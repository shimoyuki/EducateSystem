		...
		<div id="id_25" style="border: none;">
			<form id="formTeac" action="<%=basePath%>teac/modifyTeac?id=${teac.id }"
							...
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="staffnum"
											value="<fmt:formatNumber type="number" value="${teac.staffnum }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="staffadmin"
											value="<fmt:formatNumber type="number" value="${teac.staffadmin }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="staffprepjob"
											value="<fmt:formatNumber type="number" value="${teac.staffprepjob }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="fulltime"
											value="<fmt:formatNumber type="number" value="${teac.fulltime }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="basiccourse"
											value="<fmt:formatNumber type="number" value="${teac.basiccourse }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="course"
											value="<fmt:formatNumber type="number" value="${teac.course }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control"
											name="industryenterprise" value="<fmt:formatNumber type="number" value="${teac.industryenterprise }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="undergraless"
											value="<fmt:formatNumber type="number" value="${teac.undergraless }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="undergra"
											value="<fmt:formatNumber type="number" value="${teac.undergra }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="fullpostgrad"
											value="<fmt:formatNumber type="number" value="${teac.fullpostgrad }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="subhighmore"
											value="<fmt:formatNumber type="number" value="${teac.subhighmore }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control"
											name="intermediategrade" value="<fmt:formatNumber type="number" value="${teac.intermediategrade }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="juniortitle"
											value="<fmt:formatNumber type="number" value="${teac.juniortitle }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="noconferteac"
											value="<fmt:formatNumber type="number" value="${teac.noconferteac }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
						</tbody>
					</table>
							...
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="threefiveless"
											value="<fmt:formatNumber type="number" value="${teac.threefiveless }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control"
											name="threesixfourfive" value="<fmt:formatNumber type="number" value="${teac.threesixfourfive }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="foursixfivefive"
											value="<fmt:formatNumber type="number" value="${teac.foursixfivefive }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="fivesixmore"
											value="<fmt:formatNumber type="number" value="${teac.fivesixmore }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="male"
											value="<fmt:formatNumber type="number" value="${teac.male }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="female"
											value="<fmt:formatNumber type="number" value="${teac.female }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" id="lessThanSN" class="form-control"
											name="doubleteac" value="<fmt:formatNumber type="number" value="${teac.doubleteac }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="induenterhour"
											value="<fmt:formatNumber type="number" value="${teac.induenterhour }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control"
											name="counselcertificate" value="<fmt:formatNumber type="number" value="${teac.counselcertificate }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="fulltimecounsel"
											value="<fmt:formatNumber type="number" value="${teac.fulltimecounsel }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control"
											name="citydiscipleader" value="<fmt:formatNumber type="number" value="${teac.citydiscipleader }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
							<tr>
								...
								<td><div class="form-group">
										<input type="text" class="form-control" name="provsuper"
											value="<fmt:formatNumber type="number" value="${teac.provsuper }" maxFractionDigits="0" groupingUsed="false"/>">
									</div></td>
							</tr>
						</tbody>
					</table>
				...
				<c:if test="${detailFlag==0}">
					...
					<input id="reset" class="id_31" type="reset" onclick="location.href='showTeacInfo'" value="返回">
				</c:if>
