...
<table class="id_27">
    ...
    <tr >
      ...
      <td><div class="form-group">     
       <select id="schoolRun" name="schoolRun" class="form-control" >       	
    	    <option value="0" <c:if test="${size.schoolRun==0 }"> selected="selected"</c:if>>公办</option>  					  
    		<option value="1" <c:if test="${size.schoolRun==1 }"> selected="selected"</c:if>>民办</option>
    		<option value="2" <c:if test="${size.schoolRun==2 }"> selected="selected"</c:if>>混合制</option>   
	 	</select>
	 </div></td>
    </tr>
    <tr>
    ...
    <%-- <tr >
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="adminOfficeArea" value="${size.adminOfficeArea}"> </div></td>
    </tr> --%>
    <tr >
...
<table class="id_27">
    ...
    <tr >
      ...
      <td><div class="form-group">
      	<select id="schoolLevel" name="schoolLevel"  class="form-control">  
    		<option value="0" <c:if test="${size.schoolLevel==0 }"> selected="selected"</c:if>>一般</option>  
    		<option value="1" <c:if test="${size.schoolLevel==1 }"> selected="selected"</c:if>>国示校</option>
    		<option value="2" <c:if test="${size.schoolLevel==2 }"> selected="selected"</c:if>>国重校</option>
			<option value="3" <c:if test="${size.schoolLevel==3 }"> selected="selected"</c:if>>省重校</option>   
	 	</select>
	 </div></td>
    </tr>
    <tr>
      <th scope="row">办学主体</th>
       <td><div class="form-group">
      	<select id="schoolSubject" name="schoolSubject"  class="form-control">  
    		<option value="0" <c:if test="${size.schoolSubject==0 }"> selected="selected"</c:if>>教育行政部</option>  
    		<option value="1" <c:if test="${size.schoolSubject==1 }"> selected="selected"</c:if>>人社部门</option>
    		<option value="2" <c:if test="${size.schoolSubject==2 }"> selected="selected"</c:if>>行业</option>
	 	</select>
	 </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">巩固率</th>
      <td><div class="form-group"><input type="text" class="form-control" name="threeConsol" value="${size.threeConsol}"> </div></td>
    </tr>
  </tbody>
    </table>
    </div>
