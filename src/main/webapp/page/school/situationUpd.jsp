...
<div class="id_29" style="clear:both">
   	<c:if test="${detailFlag==0}">                                                
			<input class="id_31" id="submit"  type="submit" value="提交" onclick="return checknum()">
			<input class="id_31" type="button" onclick="location.href='<%=basePath%>schoolenterprise/getSchoolenterpriseList'" value="返回">
		</c:if>
