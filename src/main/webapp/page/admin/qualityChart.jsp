	...
	<div id="id_11">
		...
		<div class="id_12">
			<form id="myForm" method="post"
				action="<%=basePath%>chartAnalysis/getQualityChart">
				<div style="overflow: auto;">
					内容： <select id="model" name="content" class="id_40" onchange="selectChange()">
						<option value="majorlayout">专业布局</option>
						<option value="majornum">课程开设</option>
						<option value="qualityassure">质量保证</option>
						<option value="educationtrain">教师培养培训</option>
					</select> 
