	...
	<div id="id_11">
		...
		<div class="id_12">
			<form id="myForm" method="post"
				action="<%=basePath%>chartAnalysis/getStudentsChart">
				<div style="overflow: auto;">
					内容： <select id="model" name="content" class="id_40" onchange="selectChange()">
						<option value="studentquality">学生素质</option>
						<option value="experience">在校体验</option>
						<option value="employquality">就业质量</option>
					</select> 
