	...
	<div id="id_11">
		...
		<div class="id_12">
			<form id="myForm" method="post"
				action="<%=basePath%>chartAnalysis/getSocialChart">
				<div style="overflow: auto;">
					内容： <select id="model" name="content" class="id_40" onchange="selectChange()">
						<option value="skilltrain">技术技能人才培养</option>
						<option value="socialservice">社会服务</option>
						<option value="counpasupp">对口支援</option>
					</select> 
