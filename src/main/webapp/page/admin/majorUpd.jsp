...
<body>
	...
	<div majorcode="id_11">
		...
		<!--表格区-->
		<form id="formMajor" action="<%=basePath%>major/modifyMajor"
			method="post">
						...
						<div majorcode="id_25" style="border: none;">
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="majorcode"
														value="${major.majorcode }" readonly="readonly">
												</div></td>
										</tr>
										<tr>
											<th scope="row">专业名</th>
							...
							<div class="id_29" style="clear:both">
								...
								<input id="reset" class="id_31" type="reset"
									onclick="location.href='showMajorInfo'" value="返回">
							</div>
						</div>
					</td>
				</tr>
