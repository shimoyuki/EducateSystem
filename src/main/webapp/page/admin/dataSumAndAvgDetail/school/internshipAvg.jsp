...
<table class="id_27">
   ...
   <tr>
    ...
    <tr >
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="offcampttrainbase" value="<fmt:formatNumber type="number" value="${internship.offcampttrainbase }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr>
      <th scope="row">生均认识实习时长（天）</th>
      <td><div class="form-group"><input type="text" class="form-control" name="kownduration" value="<fmt:formatNumber type="number" value="${internship.kownduration }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr>
      <th scope="row">生均跟岗实习时长（天）</th>
      <td><div class="form-group"><input type="text" class="form-control" name="postduration" value="<fmt:formatNumber type="number" value="${internship.postduration }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr>
      <th scope="row">生均顶岗实习时长（天）</th>
      <td><div class="form-group"><input type="text" class="form-control" name="postduration" value="<fmt:formatNumber type="number" value="${internship.displaceduration }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>   
    <tr >
