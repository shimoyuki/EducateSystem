...
<!--添加删除修改-->
<div class="id_12">
<div class="id_13"><span>校企合作</span><i></i><a href="#">合作情况平均值</a></div>
<div class="id_14">
...
<table class="id_27">
   ...
   <tr >
      ...
      <td>
      	<div class="form-group">
      		<input id="majornum" type="text" class="form-control" name="majornum" value="<fmt:formatNumber type="number" value="${schoolenterprise.majornum }" maxFractionDigits="2" groupingUsed="false"/>" onblur="checknum()">
    ...
    <tr>
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="coopagreeenterp" value="<fmt:formatNumber type="number" value="${schoolenterprise.coopagreeenterp }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr>
      <th scope="row">签订合作协议的专业数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="coopagreemajor" value="<fmt:formatNumber type="number" value="${schoolenterprise.coopagreemajor }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr>
      <th scope="row">合作企业参与教学的专业数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="coopenterpjointeachmajor" value="<fmt:formatNumber type="number" value="${schoolenterprise.coopenterpjointeachmajor }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr >
      <th scope="row">合作企业参与教学的教师数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="coopenterpjointeachteacher" value="<fmt:formatNumber type="number" value="${schoolenterprise.coopenterpjointeachteacher }" maxFractionDigits="2" groupingUsed="false"/>" ></div></td>
    </tr>
    <tr >
      <th scope="row">合作企业参与教学课时数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="coopenterpjointeachclass" value="<fmt:formatNumber type="number" value="${schoolenterprise.coopenterpjointeachclass }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <%-- <tr >
...
<table class="id_27">
    ...
    <tr >
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="enterpbuildreseadevelop" value="<fmt:formatNumber type="number" value="${schoolenterprise.enterpbuildreseadevelop }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr >
      <th scope="row">校外教师培训基地数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="offschoteachertrainbase" value="<fmt:formatNumber type="number" value="${schoolenterprise.offschoteachertrainbase }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <%-- <tr >
    ...
    <tr >
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="schoenterpcooporderclassnum" value="<fmt:formatNumber type="number" value="${schoolenterprise.schoenterpcooporderclassnum }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr >
      <th scope="row">校企合作开发课程数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="schoenterpdevelopcourse" value="<fmt:formatNumber type="number" value="${schoolenterprise.schoenterpdevelopcourse }" maxFractionDigits="2" groupingUsed="false"/>"></div></td>
    </tr>
    <tr >
    ...
    <tr >
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="parttimeclassradio" value="${schoolenterprise.parttimeclassradio }"></div></td>
    </tr>
    <%-- <tr >
      <th scope="row">接收顶岗实习学生比例</th>
      <td><div class="form-group"><input type="text" class="form-control" name="receivepost" value="${schoolenterprise.receivepost }"></div></td>
    </tr>
    <tr >
      <th scope="row">录取应届毕业生比例</th>
      <td><div class="form-group"><input type="text" class="form-control" name="recruitgradute" value="${schoolenterprise.recruitgradute }"></div></td>
    </tr> --%>
  </tbody>
    </table>
