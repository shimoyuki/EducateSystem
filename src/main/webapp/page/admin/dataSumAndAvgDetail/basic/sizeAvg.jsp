...
<!--添加删除修改-->
<div class="id_12">
<div class="id_13"><span>基本情况</span><i></i><a href="">规模平均值</a></div>
<div class="id_14">
</div>
</div>
<!--表格区-->
...
<table class="id_27">
    ...
    <tr>
      ...
      <td><div class="form-group"><input type="text" class="form-control" name="totalStudent" value=<fmt:formatNumber type="number" value="${size.totalStudent}" maxFractionDigits="2" groupingUsed="false"/>> </div></td>
    </tr>
    <tr>
      <th scope="row">毕业生数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="annualGraduate" value=<fmt:formatNumber type="number" value="${size.annualGraduate}" maxFractionDigits="2" groupingUsed="false"/>> </div></td>
    </tr>
    <tr>
      <th scope="row">当年招生总数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="enrollment" value=<fmt:formatNumber type="number" value="${size.enrollment}" maxFractionDigits="2" groupingUsed="false"/>> </div></td>
    </tr>
    <tr>
      <th scope="row">专业数</th>
      <td><div class="form-group"><input type="text" class="form-control" name="majors" value=<fmt:formatNumber type="number" value="${size.majors}" maxFractionDigits="2" groupingUsed="false"/>> </div></td>
    </tr>
    <tr>
      <th scope="row">巩固率</th>
