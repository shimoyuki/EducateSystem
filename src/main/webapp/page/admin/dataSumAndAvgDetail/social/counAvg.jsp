...
<body>
	...
	<div id="id_11">
		...
		<div class="id_12">
			<div class="id_13">
				<span>基本情况</span><i></i><a>对口支援平均值</a>
			</div>
		</div>
		<!--表格区-->
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="helpobject"
														value="<fmt:formatNumber type="number" value="${coun.helpobject }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="poverreductarget"
														value="<fmt:formatNumber type="number" value="${coun.poverreductarget }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="servicenum"
														value="<fmt:formatNumber type="number" value="${coun.servicenum }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
									</tbody>
								</table>
