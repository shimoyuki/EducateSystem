...
<body>
	...
	<div id="id_11">
		...
		<div class="id_12">
			<div class="id_13">
				<span>基本情况</span><i></i><a>技术技能人才培养平均值</a>
			</div>
		</div>
		<!--表格区-->
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="localfoster"
														value="<fmt:formatNumber type="number" value="${skiTra.localfoster }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="localtrain"
														value="<fmt:formatNumber type="number" value="${skiTra.localtrain }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="trackproblemnum"
														value="<fmt:formatNumber type="number" value="${skiTra.trackproblemnum }" maxFractionDigits="2" groupingUsed="false"/>">
												</div></td>
										</tr>
									</tbody>
								</table>
