						...
						<div id="id_25" style="border: none;">
										...
										<tr>
											...
											<td><div class="form-group">
													<input type="text" class="form-control" name="soldier"
														value="<fmt:formatNumber type="number" value="${emp.soldier }" maxFractionDigits="0" groupingUsed="false"/>">
												</div></td>
										</tr>
										<tr>
							...
							<div class="id_29" style="clear:both">
								<c:if test="${detailFlag==0}">                                                
									...
									<input class="id_31" type="button" onclick="location.href='<%=basePath%>emp/showEmpInfo'" value="返回">
								</c:if>
